...
class ArtistHandler(webapp2.RequestHandler):
    def post(self):
        ...
        self.response.write(artist_template.render({"name": name,
            ...
            "spotify": artist_info[name]['spotify'],
            "bio": artist_info[name]['bio']}))


app = webapp2.WSGIApplication([('/', WelcomeHandler),('/artists', ArtistsHandler),('/artist', ArtistHandler),], debug=True)
